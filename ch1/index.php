...
d=1
printf -v j "%03d" $d
while wget -O sound$j.mp3 "https://media.pearsoncmg.com/ph/chet/chet_mymedtermlab/turley4e/lecture/turley_ch01_lecture/data/sound$d.mp3"; do
		((d++))
		printf -v j "%03d" $d
done
...
$feedURL = "https://jtgasper3.github.io/ch1";
$feedBaseURL = "https://jtgasper3.github.io/ch1/"; // must end in trailing forward slash (/).
...
<rss version="2.0">
	<channel>
		...
		<image>
			...
			<link>https://jtgasper3.github.io/ch1/rss.xml</link>
		</image>
		<ttl>180</ttl>
<?
$files = scandir("./");
